...
export const translations = {
  ...
  al: {
    ...
    'about.whoWeAre.content': 'Ne jemi nje agienci e dizajnit dhe zhvillimit te web-it e fokusuar ne krijimin e pervojave dixhitale me ndikim te lart. Ne Prestige Websites, Çdo web ndërtohet me kujdes për tu përshtatur me marken tuaj, per tu lidhur me audiencen tuaj dhe per te drejtuar rritjen afatgjate. Klientet tanë varione nga biznese fillestare ambicioze deri te biznese te vendosura qe kuptojnë se sa e fuqishme mund te jete nje prezencë e fortë online kur bëhet në mënyren e saktë.',
    'about.whyChoose.title': 'Pse të Na Zgjidhni Ne',
    'about.whyChoose.content': 'Ne kombinojmë dizajnin e mprehtë, strategjinë e zgjuar dhe zhvillimin e performancës së parë për të krijuar web-e që nuk duken vetëm të mira, por që japin edhe rezultate të matshme. Procesi ynë është i drejtuar nga çdo vendim të bazuar në qëllimet e biznesit tuaj, përdoruesit tuaj dhe se si të ktheni vëmendjen në veprim. Nga struktura dhe paraqitja deri te animacionet më të vogla, gjithçka është krijuar me qëllim. Ne shkojmë përtej krijimit — optimizojmë vazhdimisht faqen tuaj, përmirësojmë performancën, rrisim përvojën e përdoruesit dhe e përshtasim me rritjen tuaj në mënyrë që web-i juaj të vazhdojë të japë rezultate edhe shumë kohë pas se të jetë live. Kjo nuk është thjesht një krijim web-i, është një investim afatgjatë për të rritur biznesin tuaj.',
    'about.strategic.title': 'SEO Strategjik i Ndërtuar për Rritje',
    'about.strategic.content': 'Të kesh një web të shkëlqyer nuk do të thotë asgjë nëse askush nuk e sheh. Kjo është arsyeja pse SEO nuk është një shtesë në procesin tonë — është e ndërtuar në themelin e çdo projekti që marrim përsipër. Optimizimi i Motorëve të Kërkimit (SEO) është ajo që ndihmon web-in tuaj të renditet më lart në Google dhe motorë të tjerë kërkimi kur klientët e mundshëm kërkojnë për produktet ose shërbimet që ofroni. Pa të, faqja juaj është thjesht një faqe tjetër e padukshme në internet. Me të, biznesi juaj bëhet i zbulueshëm, i besuar dhe i zgjedhur. Ne shkojmë shumë përtej mbushjes bazike të fjalëve kyçe. Qasja jonë SEO është e drejtuar nga të dhënat, strategjike dhe në evoluim të vazhdueshëm. Kemi specialistë që gjurmojnë, analizojnë dhe rafinojnë performancën tuaj SEO çdo muaj — monitorojnë modelet e trafikut, studiojnë sjelljen e përdoruesve, rishikojnë pozicionet e renditjes dhe rregullojnë përmbajtjen dhe strukturën bazuar në rezultate të vërteta. Faqja juaj nuk krijohet vetëm dhe optimohet një herë, por merr përditësime të rregullta për të mbetur gjithmonë e tillë.',
    'about.values.title': 'Çfarë Vlerësojmë',
    'about.values.content': 'Ne vlerësojmë transparencën në çdo hap të procesit — nga komunikimi i hapur dhe afatet e qarta deri te reagimet e ndershme dhe përgjegjshmëria. Ne japim përparësi performancës duke ndërtuar web-e të shpejta, që përgjigjen dhe të fokusuara në konvertim të mbështetura nga të dhënat dhe rezultatet e botës reale. Bashkëpunimi është në thelbin e mënyrës se si punojmë; vizioni dhe qëllimet tuaja udhëheqin çdo vendim që marrim. Dhe mbi të gjitha, ne vlerësojmë cilësinë — pa shkurtesa, pa kompromise, vetëm punë për të cilën jemi krenarë të qëndrojmë pas.',
