...
export const translations = {
  ...
  al: {
    ...
    'about.whoWeAre.content': 'Ne jemi një agjenci butike e dizajnit dhe zhvillimit të uebit e fokusuar në krijimin e përvojave dixhitale me ndikim të lartë. Në Prestige Websites, çdo uebsajt ndërtohet me kujdes për t\'u përshtatur me markën tuaj, për t\'u lidhur me audiencën tuaj dhe për të drejtuar rritjen afatgjatë. Klientët tanë variojnë nga startup-e ambicioze deri te biznese të vendosura që kuptojnë se sa e fuqishme mund të jetë një prezencë e fortë online kur bëhet siç duhet.',
    'about.whyChoose.title': 'Pse të Na Zgjidhni',
    'about.whyChoose.content': 'Ne kombinojmë dizajnin e mprehtë, strategjinë e zgjuar dhe zhvillimin e performancës së parë për të krijuar uebsajte që nuk duken vetëm të mira — ato japin rezultate të matshme. Procesi ynë është i drejtuar nga detajet dhe i qëllimshëm, me çdo vendim të bazuar në qëllimet e biznesit tuaj, përdoruesit tuaj dhe se si të ktheni vëmendjen në veprim. Nga struktura dhe paraqitja deri te animacionet më të vogla, gjithçka është krijuar me qëllim. Ne shkojmë përtej lansimit — optimizojmë vazhdimisht sajtin tuaj, përmirësojmë performancën, rrisim përvojën e përdoruesit dhe përshtatemë me rritjen tuaj në mënyrë që uebsajti juaj të vazhdojë të japë rezultate shumë kohë pas se të jetë live. Kjo nuk është thjesht dizajn web. Është një aktiv dixhital afatgjatë i ndërtuar për të rritur biznesin tuaj.',
    'about.strategic.title': 'SEO Strategjik i Ndërtuar për Rritje',
    'about.strategic.content': 'Të kesh një uebsajt të shkëlqyer nuk do të thotë asgjë nëse askush nuk e sheh. Kjo është arsyeja pse SEO nuk është një shtesë në procesin tonë — është e ndërtuar në themelin e çdo projekti që marrim përsipër. Optimizimi i Motorëve të Kërkimit (SEO) është ajo që ndihmon uebsajtin tuaj të renditet më lart në Google dhe motorë të tjerë kërkimi kur klientët e mundshëm kërkojnë për produktet ose shërbimet që ofroni. Pa të, sajti juaj është thjesht një faqe tjetër e padukshme në internet. Me të, biznesi juaj bëhet i zbulueshëm, i besuar dhe i zgjedhur. Ne shkojmë shumë përtej mbushjes bazike të fjalëve kyçe. Qasja jonë SEO është e drejtuar nga të dhënat, strategjike dhe në evoluim të vazhdueshëm. Kemi specialistë që gjurmojnë, analizojnë dhe rafinojnë performancën tuaj SEO çdo muaj — monitorojnë modelet e trafikut, studiojnë sjelljen e përdoruesve, rishikojnë pozicionet e renditjes dhe rregullojnë përmbajtjen dhe strukturën bazuar në rezultate të vërteta. Kjo do të thotë që sajti juaj nuk lansohet vetëm i optimizuar — mbetet i optimizuar.',
    ...
    'portfolio.subtitle': 'Zbuloni portofolinë tonë të uebsajteve mahnitëse dhe përvojave dixhitale që kanë transformuar bizneset dhe kanë magjepsur audienca në mbarë botën.',
    ...
    'testimonials.subtitle': 'Rezultate të vërteta nga biznese të vërteta që na besuan suksesin e tyre SEO',
    'testimonials.client1.name': 'Sarah Johnson',
